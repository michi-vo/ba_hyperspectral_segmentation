...
class loadDataOp(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        biopsy_ref_name = "Biopsy_S1_reflectance" # Load Biopsy probe as reference, used to cancel out noise later
        biopsy_name = "Biopsy_S2_reflectance" # Load Biopsy probe in question
